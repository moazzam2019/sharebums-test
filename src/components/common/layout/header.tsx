...
import {
  Layout, Badge, Drawer, Divider, Avatar, Dropdown, Menu
} from 'antd';
...
import {
  ...
  LogoutOutlined, HeartOutlined, BlockOutlined, PlusCircleOutlined, StopOutlined, HomeOutlined
} from '@ant-design/icons';
import {
  HomeIcon, ModelIcon, PlusIcon, MessageIcon, UserIcon, LiveIcon, TickIcon, WalletSvg, ImageIcon, VideoIcon
} from 'src/icons';
              ...
              <ul className={user._id ? 'nav-icons' : 'nav-icons custom'}>
                ...
                {user._id && (
                  <div className="icons-item">
                    ...
                    <>
                      {user?.isPerformer && (
                      <li className={router.pathname === '/model/my-post/create' ? 'active cutoms' : 'cutoms'}>
...
const mapDispatch = {
  logout, updateUIValue, updateBalance
};
