...
import "./Compose.less";
import { SendIcon, SendHoverIcon } from "src/icons";
...
class Compose extends PureComponent<IProps> {
  ...
  componentDidUpdate(previousProps) {
    ...
    if (
      previousProps?.sendMessageStatus?.success !==
      ...
      <div className="compose">
        ...
        <div className="compose-right">
          <div className="grp-icons" style={{ paddingRight: 0 }}>
            ...
            >
              {text.length > 0 ? <SendHoverIcon /> : <SendIcon />}
            </div>
          </div>
        </div>
        <Modal
        ...
        >
          <TipPerformerForm
            performer={conversation.recipientInfo}
            submiting={submiting}
